...
const UpdateStory = () => {
  ...
  const userId = snap.currentUser?.uid;
      ...
      >
        ...
        >
          ...
          <Row gutter={[16, 16]}>
            <Col span={16}>
              <div>
                <Text type="secondary" style={{ fontSize: '13px', color: themeColors.textSecondary }}>Title</Text>
                <div style={{ fontSize: '16px', fontWeight: 500, color: themeColors.textPrimary }}>{workoutStory?.title}</div>
              </div>
            </Col>
            <Col span={8}>
              <div>
                <Text type="secondary" style={{ fontSize: '13px', color: themeColors.textSecondary }}>Date</Text>
                <div style={{ color: themeColors.textPrimary }}>{workoutStory?.timestamp ? moment(workoutStory.timestamp).format('YYYY-MM-DD') : 'N/A'}</div>
              </div>
            </Col>
            <Col span={12}>
              <div>
                <Text type="secondary" style={{ fontSize: '13px', color: themeColors.textSecondary }}>Learning Type</Text>
                <div style={{ color: themeColors.textPrimary }}>{workoutStory?.exerciseType || 'N/A'}</div>
              </div>
            </Col>
            <Col span={12}>
              <div>
                <Text type="secondary" style={{ fontSize: '13px', color: themeColors.textSecondary }}>Category</Text>
                <div>
                  <Tag color={
            ...
            <Col span={12}>
              <div>
                <Text type="secondary" style={{ fontSize: '13px', color: themeColors.textSecondary }}>Duration</Text>
                <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Col span={12}>
              <div>
                <Text type="secondary" style={{ fontSize: '13px', color: themeColors.textSecondary }}>Difficulty Level</Text>
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  <FireOutlined style={{ 
                    marginRight: '8px',
            ...
            <Col span={24}>
              ...
              <div>
                <Text type="secondary" style={{ fontSize: '13px', color: themeColors.textSecondary }}>Description</Text>
                <div style={{ 
                  marginTop: '8px', 
                  whiteSpace: 'pre-wrap',
                ...
                {(uploadedImage || workoutStory?.image) ? (
                  <div style={{ 
                    ...
                    <div style={{
                      ...
                      background: 'linear-gradient(to top, rgba(0, 254, 17, 0.14) 0%, rgba(0,0,0,0) 100%)',
                      display: 'flex',
                      justifyContent: 'center'
                    }}>
                      <Upload
